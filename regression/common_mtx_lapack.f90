...
!!!  use common
  ...
  integer, private, parameter :: r_size = 4
  integer, private, parameter :: r_sngl = 4
  integer, private, parameter :: r_dble = 8
  integer, private, parameter :: RP_EVP = 4
...
SUBROUTINE mtx_inv(n,a,ainv)
  ...
  CALL dgetri(n,awork,n,kpvt,work,lwork,info)
